...
const areas = [
  { name: '업무 공간', img: '/office-cleaning/office-work.jpg', items: ['책상·사무기기 먼지 제거', '의자 청소', '파티션 유리 청소', '전화기·키보드 소독', '서랍장 외부 청소'] },
  { name: '회의실·로비', img: '/office-cleaning/office-meeting.jpg', items: ['테이블 및 의자 청소', '화이트보드 청소', '바닥 청소 및 광택', '유리문·창문 청소', '천장 먼지 제거'] },
  { name: '탕비실·주방', img: '/office-cleaning/office-kitchen.jpg', items: ['싱크대 청소', '전자레인지 내외부', '냉장고 외부', '커피머신 주변', '바닥 청소'] },
  { name: '화장실', img: '/office-cleaning/office-restroom.jpg', items: ['변기 세척 및 소독', '세면대 청소', '거울 청소', '바닥 청소', '배수구 청소'] },
]

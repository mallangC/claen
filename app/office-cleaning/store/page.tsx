...
const areas = [
  { name: '매장 내부', img: '[ 매장 내부 청소 이미지 ]', items: ['진열대 먼지 제거', '쇼케이스 청소', '계산대 주변 청소', '바닥 청소 및 광택', '천장 조명 청소'] },
  { name: '주방·조리실', img: '[ 주방·조리실 청소 이미지 ]', items: ['그리스트랩 청소', '후드 및 덕트 청소', '주방 기기 외부', '타일 기름때 제거', '배수구 청소'] },
  { name: '화장실·창고', img: '[ 화장실·창고 청소 이미지 ]', items: ['위생도기 세척', '바닥 청소', '창고 정리 청소', '배수구 청소', '환풍구 청소'] },
  { name: '외부·간판', img: '[ 외부·간판 청소 이미지 ]', items: ['출입문 청소', '쇼윈도 청소', '외벽 청소', '간판 청소', '주변 바닥 청소'] },
]

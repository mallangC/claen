...
const areas = [
  { name: '실내 공간', img: '[ 실내 공간 청소 이미지 ]', items: ['건설 분진 전체 제거', '페인트 자국 제거', '시멘트 잔여물 제거', '바닥재 보호 및 광택', '천장·벽면 청소'] },
  { name: '유리·창호', img: '[ 유리·창호 청소 이미지 ]', items: ['창문 내외부 청소', '창틀 잔여물 제거', '유리문 청소', '방충망 청소', '새시 프레임 청소'] },
  { name: '위생도기', img: '[ 위생도기 청소 이미지 ]', items: ['변기·세면대 보호막 제거', '욕조 청소', '타일 줄눈 청소', '수전 청소', '배수구 청소'] },
  { name: '공용 공간', img: '[ 공용 공간 청소 이미지 ]', items: ['엘리베이터 내부', '계단·복도', '지하주차장', '옥상 청소', '외벽 청소'] },
]
